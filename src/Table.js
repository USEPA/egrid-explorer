            ...
            style={{
              backgroundColor:
                this.props.type === this.props.table_info[r].type
                  ? this.props.highlight_color
                  : "#fff",
              fontWeight: this.props.type === this.props.table_info[r].type ? "bold" : "normal",
            }}
          >
            <td>{r}</td>
            <td>{this.props.table_info[r]['US_'+this.props.table_info[r].type]}</td>
            <td>{this.props.table_info[r][this.props.table_info[r].type]}</td>
          </tr>
        );
